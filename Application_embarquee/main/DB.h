...
Big Endian et Little Indian
    Selon l'architecture du microprocesseur, l'ordre des octets en mémoire peut différer.
    Exemple avec un uint32_t : 0x000007D0 == 2000 sera codé 0xD0070000 en mémoire
    Cet ordre n'est pas modifié avec les octets et les char : ASCII "1234" codé 0x31323334 en mémoire
    Cette distinction est sans effet sur le code, mais peut affecter l'affichage brut comparé à l'affichage typé.
------------------------------------------------------*/
/* exemples :
...
// liste le contenu de la DB, avec un message optionnel en tête.
void AfficheDB();
